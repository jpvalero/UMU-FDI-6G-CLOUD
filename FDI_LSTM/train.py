...
train_split, test_split = train_test_split(df_y, TRAIN_TEST_SPLIT)
train_dataset = LoadPredictionDataset(df_y, time_step=TIME_STEP, column=COLUMN, start_index=0, population=train_split, device=device)
